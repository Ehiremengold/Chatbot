...
if user_input4 == 'how are you':
  ...
  print('q-bot:Lol i think you would definetely be older than me')
elif user_input4 == 'what is your name':
  print('q-bot:my name is q-bot!')
elif user_input4 == 'are you human':
  print('q-bot:lol '+ user_input2 + ' you are funny, definitely i am not')
elif user_input4 == 'what\'s your name':
  print('q-bot:my name is q-bot!')
elif user_input4 == 'who made you':
  print('q-bot:Ehis made me, i believe God made you.')
elif user_input4 == 'are you still there':
  print('q-bot:Yes, anytime!')
